...
class Ui_MainWindow(object):
    ...
    def db_input(self,txt):
        if self.con:
            try:
                ...
                with self.db as db:
                    ...
                    if 'select' in txt:
                        ...
                        self.table.setGeometry(QtCore.QRect(60, 400, 800, 400))
                ...
                error_1=QMessageBox()
                error_1.setWindowTitle("Error")
                error_1.setText(str(e))
                error_1.setIcon(QMessageBox.Warning)
                error_1.setStandardButtons(QMessageBox.Ok)
            ...
            error.setText("Please connect to DB")
